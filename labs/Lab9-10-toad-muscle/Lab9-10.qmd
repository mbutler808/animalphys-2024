...
$$
PCSA = \frac{muscle volume}{fiber length} = \frac{muscle mass}{\rho fiber length}
$$

Where $\rho$ is the density of the muscle is 1.06 g/ml. 

![Pennate muscle fiber arrangements. The green lines represent PCSA; the blue lines represent ACSA. Image credit: Uwe Gille, CC BY-SA 3.0 <https://creativecommons.org/licenses/by-sa/3.0>, via Wikimedia Commons](../../images/256px-Fiederung.svg.png) 
